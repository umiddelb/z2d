# Zero to Docker with Ubuntu Core within 5 minutes

This repo contains a collection of scripts helping you to set up Ubuntu Core 14.04.2 / Debian 8 Jessie and Docker 
