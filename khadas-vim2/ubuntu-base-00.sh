...
sudo dd if=u-boot-v2015.01_VIM2_Ubuntu_20180712.bin.sd.bin of=/dev/mmcblk0 conv=fsync,notrunc bs=1 count=444
sudo dd if=u-boot-v2015.01_VIM2_Ubuntu_20180712.bin.sd.bin of=/dev/mmcblk0 conv=fsync,notrunc bs=512 skip=1 seek=1
